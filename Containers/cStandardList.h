...
#ifndef _cStandardList_HG_
#define _cStandardList_HG_

#include <list>

#include "iPersonMotron.h"

class cStandardList : public iPersonMotron {
public:
